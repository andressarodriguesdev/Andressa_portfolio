        ...
        <div className="grid lg:grid-cols-[1fr,1.5fr] gap-12 items-center">
          ...
          <div className="text-center lg:text-left space-y-8">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl">
              Desenvolvedora de software com forte interesse em criar soluções
              que unam eficiência, organização e impacto real.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Button
                ...
                onClick={() =>
                  window.open(
                    "mailto: andressa.rodrigues.2172@gmail.com",
                    "_blank"
                  )
                }
              >
            ...
            <div className="flex justify-center lg:justify-start space-x-6">
              <Button
                ...
                onClick={() =>
                  window.open(
                    "https://github.com/andressarodriguesdev",
                    "_blank"
                  )
                }
              >
              ...
              <Button
                ...
                onClick={() =>
                  window.open(
                    "https://www.linkedin.com/in/andressa-macedo-rodrigues/",
                    "_blank"
                  )
                }
              >
              ...
              <Button
                ...
                className="hover:text-primary hover:bg-primary/10"
                onClick={() =>
                  window.open("https://wa.me/5561981227461", "_blank")
                }
              >
            ...
            <div className="relative">
              <div className="relative">
                <img
                  ...
                  className="w-full h-auto mx-auto lg:max-w-none"
                  style={{
